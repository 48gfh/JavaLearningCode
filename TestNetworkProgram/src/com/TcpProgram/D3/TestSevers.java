...
public class TestSevers {
    public static void main(String[] args) throws IOException {
        ...
        //向客户端发送数据
        OutputStream outputDataStream = S.getOutputStream();
        DataOutputStream dataOutputStream= new DataOutputStream(outputDataStream);
        dataOutputStream.writeUTF("服务器正常接收");
